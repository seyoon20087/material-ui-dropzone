...
var deepmerge = require('@mui/utils/deepmerge');
var jsxRuntime = require('react/jsx-runtime');
var IconButton = require('@mui/material/IconButton');
var SnackbarContent = require('@mui/material/SnackbarContent');
...
var styledEngine = require('@mui/styled-engine');
...
const StyledGrid = styles.styled(Grid)(({
  theme: {
    palette,
    shape,
    spacing,
...
function PreviewList({
  ...
  return /*#__PURE__*/jsxRuntime.jsx(StyledGrid, {
    ...
    children: fileObjects.map((fileObject, i) => {
      ...
      }, getPreviewIcon(fileObject, classes$2), showFileNames && /*#__PURE__*/jsxRuntime.jsx(Typography, {
        variant: "body1",
        component: "p",
        children: fileObject.file.name
      }), /*#__PURE__*/jsxRuntime.jsx(Fab, {
        onClick: handleRemove(i),
        "aria-label": "Delete",
        className: classes$2.removeButton,
        children: _DeleteIcon || (_DeleteIcon = /*#__PURE__*/jsxRuntime.jsx(DeleteIcon, {}))
      }));
    })
  });
}
...
const StyledSnackbarContent = styles.styled(SnackbarContent)(({
  theme
}) => ({
...
function SnackbarContentWrapper(props) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(StyledSnackbarContent, {
    className: clsx(classes$1[`${variant}Alert`], className),
    "aria-describedby": "client-snackbar",
    message: /*#__PURE__*/jsxRuntime.jsxs("span", {
      id: "client-snackbar",
    ...
    action: [/*#__PURE__*/jsxRuntime.jsx(IconButton, {
      "aria-label": "Close",
      color: "inherit",
...
const progress = styledEngine.keyframes({
  "0%": {
...
const StyledDropzoneRoot = styles.styled("div")(({
  theme: {
    palette,
    shape,
    spacing,
...
const StyledResetButton = styles.styled(Button)(({
  theme
}) => ({
...
const defaultGetPreviewIcon = (fileObject, classes) => {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(AttachFileIcon, {
    className: classes.image
  });
};
 ...
 */
class DropzoneAreaBase extends React__namespace.PureComponent {
  state = {
    openSnackBar: false,
    snackbarMessage: "",
  ...
  dropzoneRootRef = /*#__PURE__*/React__namespace.createRef();
    ...
    return /*#__PURE__*/jsxRuntime.jsxs(React.Fragment, {
      children: [/*#__PURE__*/jsxRuntime.jsx(Dropzone, {
        ...
        children: ({
          ...
          isDragReject,
          rootRef
        }) => /*#__PURE__*/jsxRuntime.jsxs(StyledDropzoneRoot, {
          ...getRootProps({
          ...
          children: [/*#__PURE__*/jsxRuntime.jsx("input", {
            ...
            }) : /*#__PURE__*/jsxRuntime.jsx(CloudUploadIcon, {
              className: classes.icon
            })]
          }), previewsInDropzoneVisible && /*#__PURE__*/jsxRuntime.jsx(PreviewList, {
      ...
      }), reset && (/*#__PURE__*/React__namespace.isValidElement(reset) ? reset : /*#__PURE__*/jsxRuntime.jsx(StyledResetButton, {
        onClick: reset.onClick,
        variant: "outlined",
        className: classes.resetButton,
        children: reset.text || "reset"
      })), previewsVisible && /*#__PURE__*/jsxRuntime.jsxs(React.Fragment, {
        children: [/*#__PURE__*/jsxRuntime.jsx(Typography, {
          variant: "subtitle1",
          component: "span",
          children: previewText
        }), /*#__PURE__*/jsxRuntime.jsx(PreviewList, {
          fileObjects: fileObjects,
          handleRemove: this.handleRemove,
          getPreviewIcon: getPreviewIcon,
      ...
      }), (typeof showAlerts === "boolean" && showAlerts || Array.isArray(showAlerts) && showAlerts.includes(snackbarVariant)) && /*#__PURE__*/jsxRuntime.jsx(Snackbar, {
        anchorOrigin: defaultSnackbarAnchorOrigin,
        autoHideDuration: 6000,
        ...alertSnackbarProps,
        open: openSnackBar,
        onClose: this.handleCloseSnackbar,
        children: /*#__PURE__*/jsxRuntime.jsx(SnackbarContentWrapper, {
          onClose: this.handleCloseSnackbar,
 ...
 */
class DropzoneArea extends React__namespace.PureComponent {
  state = {
    fileObjects: []
  };
  componentDidMount() {
  ...
  render() {
    ...
    return /*#__PURE__*/jsxRuntime.jsx(DropzoneAreaBase, {
      ...dropzoneAreaProps,
      fileObjects: fileObjects,
      onAdd: this.addFiles,
 ...
 */
class DropzoneDialogBase extends React__namespace.PureComponent {
  render() {
    ...
    return /*#__PURE__*/jsxRuntime.jsxs(Dialog, {
      ...
      children: [/*#__PURE__*/jsxRuntime.jsx(DialogTitle, {
        ...
        children: /*#__PURE__*/jsxRuntime.jsx(DropzoneAreaBase, {
          ...dropzoneAreaProps
        })
...
class DropzoneDialog extends React__namespace.PureComponent {
  state = {
    fileObjects: []
  };
  componentDidMount() {
  ...
  render() {
    ...
    return /*#__PURE__*/jsxRuntime.jsx(DropzoneDialogBase, {
      ...this.props,
      fileObjects: fileObjects,
      onAdd: this.addFiles,
      onDelete: this.deleteFile,
